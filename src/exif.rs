 ...
 * 
 * Processing order:
 * 1. fast-exif-rs datetime read (v0.11.4 composites: SubSec*, CreateDate aliases)
...
pub struct ExifProcessor {
    /// Reused reader; v0.11.4 materializes extra date aliases and SubSec composites.
...
impl ExifProcessor {
    ...
    pub fn extract_exif_data(&mut self, file_path: &Path) -> Result<ExifData> {
        ...
        // Method 1: Date-focused parse (composite SubSec* / CreateDate from v0.11.4)
    ...
    /// Date-focused read: v0.11.4 fills CreateDate aliases and SubSec* composites.
